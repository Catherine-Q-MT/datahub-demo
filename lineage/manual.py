...
lineage_mce = builder.make_lineage_mce(
    [
        builder.make_dataset_urn("s3", "datahub-cq/raw_data/hydropower-consumption.csv"),
        # Upstream connection or connections ( I am specifying the raw data in my pipeline)
